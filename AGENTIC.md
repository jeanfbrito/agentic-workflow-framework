...
- **Definition of Done**: every `todo.md` card MUST have verifiable done criteria. "Implement X" is not done. "Implement X, verify Y, tests pass" is. If you can't check it, it's not done.
